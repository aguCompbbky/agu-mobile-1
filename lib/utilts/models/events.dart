...
//   // fromJson fonksiyonu ile JSON verisini bu modele dönüştürme
...
//   // toJson fonksiyonu ile model objesini JSON'a dönüştürme
...
class Events {
  ...
  Events.fromJson(Map<String, dynamic> json) {
    ...
    printColored("ETKİNLİK TÜRÜ: ${json["etkinlik_turu"]}", "30");
